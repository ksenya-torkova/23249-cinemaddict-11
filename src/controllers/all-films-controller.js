...
export default class AllFilmsController {
  ...
  render(films) {
    ...
    const newFilms = renderAllFilms(this._filmsAllContainer, this._films.slice(0, this._shownFilmsAmount));
  ...
  _renderLoadMoreButton() {
    ...
    this._loadMoreComponent.setClickHandler(() => {
      ...
      const newFilms = renderAllFilms(this._filmsAllContainer, sortedFilms.slice(0, this._shownFilmsAmount));
  ...
  _onSortTypeChange(sortType) {
    ...
    const newFilms = renderAllFilms(this._filmsAllContainer, sortedFilms);
